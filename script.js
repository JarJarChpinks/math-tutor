...
window.onload = () => {
    // Подгружаем сохраненные данные в поля
...
function closeParentPanel() {
    ...
    // Полная перезагрузка для синхронизации всех функций
    location.reload();
}
...
function prepareTest(topic) {
    ...
    // Генерируем нужное количество (до 3000 попыток поиска уникальных)
